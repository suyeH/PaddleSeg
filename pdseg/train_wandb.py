                ...
                if args.debug:
                    ...
                    if step % args.log_steps == 0 and cfg.TRAINER_ID == 0:
                        ...
                        if args.use_vdl:
                            ...
                            wandb.log({'Train/loss': avg_loss, 'Train/lr': lr[0], 'Train/speed': speed}, step=step)
                        sys.stdout.flush()
                        avg_loss = 0.0
                        timer.restart()
        ...
        if (epoch % cfg.TRAIN.SNAPSHOT_EPOCH == 0
            ...
            if args.do_eval:
                ...
                if args.use_vdl:
                    ...
                    wandb.log({'Evaluate/mean_iou': mean_iou, 'Evaluate/mean_acc': mean_acc}, step=step)
...
def main(args):
    ...
    wandb.init(project="rs_segmentation", name=name, config=store_config, dir=cfg.LOG_DIR,
               notes="")
